...
public class AppGUI implements AppStyleArbiter {
 ...
 //    redo.setDisable(false);
  ...
  //    zoomOut.setDisable(false);
    ...
    /*    
         select= initChildButton(fileToolbarPane,	SELECTION_TOOL_ICON.toString(),	    SELECTION_TOOL_TOOLTIP.toString(),	false);
     resize= initChildButton(fileToolbarPane,	DIMENSIONS_ICON.toString(),	    DIMENSIONS_TOOLTIP.toString(),	false);
    addClass= initChildButton(fileToolbarPane,	RECTANGLE_ICON.toString(),	    RECTANGLE_TOOLTIP.toString(),	false);
      addInterface= initChildButton(fileToolbarPane,	ELLIPSE_ICON.toString(),	    ELLIPSE_TOOLTIP.toString(),	false);
     remove= initChildButton(fileToolbarPane,	REMOVE_ICON.toString(),	    REMOVE_ELEMENT_TOOLTIP.toString(),	false);
     undo= initChildButton(fileToolbarPane,	UNDO_ICON.toString(),	    UNDO_TOOLTIP.toString(),	false);
     redo= initChildButton(fileToolbarPane,	REDO_ICON.toString(),	    REDO_TOOLTIP.toString(),	false);
    
     zoomIn= initChildButton(fileToolbarPane,	ZOOMIN_ICON.toString(),	    ZOOMIN_TOOLTIP.toString(),	false);
      zoomOut= initChildButton(fileToolbarPane,	ZOOMOUT_ICON.toString(),	    ZOOMOUT_TOOLTIP.toString(),	false);
*/
...
//        select.getStyleClass().add(CLASS_FILE_BUTTON);
//     resize.getStyleClass().add(CLASS_FILE_BUTTON);
 //   addClass.getStyleClass().add(CLASS_FILE_BUTTON);
 //     addInterface.getStyleClass().add(CLASS_FILE_BUTTON);
 //    remove.getStyleClass().add(CLASS_FILE_BUTTON);
 //    undo.getStyleClass().add(CLASS_FILE_BUTTON);
 //    redo.getStyleClass().add(CLASS_FILE_BUTTON);
    
 //    zoomIn.getStyleClass().add(CLASS_FILE_BUTTON);
 //     zoomOut.getStyleClass().add(CLASS_FILE_BUTTON);
    }
}
